...
<tr><td colspan="3"> {* barra in alto, gif di sinistra LOGO a sfondo BIANCO di dimensioni 150x92,gif per il TITOLO a sfondo del colore della tabella con data e menu di navigazione di dimensioni 600x100 *}
		...
		<div id="menubar">
			<p id="Menu">&nbsp;<a href="{$common_helpByTopicUri|escape:"htmlall"}">{$common_help|lower|capitalize|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="{$common_basePath}/{$common_forumUri|escape:"htmlall"}" accesskey="2">{$common_forum|lower|capitalize|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="{$common_contactsUri|escape:"htmlall"}">{$common_contacts|lower|capitalize|escape:"htmlall"|replace:" ":"&nbsp;"}</a>&nbsp;|&nbsp;<a href="{$common_contributeUri|escape:"htmlall"}">{$common_contribute|lower|capitalize|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="{$common_accessibilityUri|escape:"htmlall"}">{$common_accessibility|lower|capitalize|escape:"htmlall"}</a>{if $common_userLoggedIn == 'true'}&nbsp;|&nbsp;<a href="{$common_settingsUri|escape:"htmlall"}">{$common_settings|escape:"htmlall"}</a>{/if}{*&nbsp;|&nbsp;<a href="/app.php">UniversiBO 3</a>*}</p>
		</div> {* /menubar *}
</td></tr>
