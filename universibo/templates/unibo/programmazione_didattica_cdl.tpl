...
<td align="left">
{if $cdl_curr.attiva=='true'}<a href="index.php?do=ProgrammazioneDidatticaCdl">{$cdl_curr.cod_corso} - {$cdl_curr.desc_corso}</a>{else}{$cdl_curr.cod_corso} - {$cdl_curr.desc_corso}{/if}</td>
