...
<div class="comandi">
{if $NewsShowCanale_addNewsFlag == "true"}<p><a href="{$NewsShowCanale_addNewsUri|escape:"htmlall"}"><img src="{$common_basePath}/tpl/unibo/news_new.gif" width="15" height="15" alt="" />
