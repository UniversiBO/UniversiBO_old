...
{foreach name=listacontatto from=$ShowContattiDocenti_contatti item=temp_contatto}
	<tr class="{cycle values="even,odd"}" {if $temp_contatto.codStato == 0}style="background-color: #7f5;"{elseif $temp_contatto.codStato == 2}style="background-color: #f33"{elseif $temp_contatto.codStato == 3}style="background-color: #bbb"{/if}>
