...
<p>&nbsp;{$showFileInfo_langDownload|escape:"htmlall"}:&nbsp;<a href="{$showFileInfo_downloadUri|escape:"htmlall"}"><img src="{$common_basePath}//unibo/file_download_32.gif" width="32" height="32" alt="{$showFileInfo_langDownload|escape:"htmlall"}" border="0" align="top" /></a></p>
 {if $showFileInfo_editFlag == 'true'}
 <p>&nbsp;{$showFileInfo_langEdit|escape:"htmlall"}:&nbsp;<a href="{$showFileInfo_editUri|escape:"htmlall"}"><img src="{$common_basePath}//unibo/file_edit_32.gif" width="32" height="32" alt="{$showFileInfo_langEdit|escape:"htmlall"}" border="0" align="top" /></a></p>
 {/if}
 {if $showFileInfo_deleteFlag == 'true'}
 <p>&nbsp;{$showFileInfo_langDelete|escape:"htmlall"}:&nbsp;<a href="{$showFileInfo_deleteUri|escape:"htmlall"}"><img src="{$common_basePath}//unibo/file_del_32.gif" width="32" height="32" alt="{$showFileInfo_langDelete|escape:"htmlall"}" border="0" align="top" /></a></p>
 {/if}
</div>
