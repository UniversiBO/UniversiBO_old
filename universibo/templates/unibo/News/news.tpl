...
<div class="news">
	<h3>::&nbsp;{$titolo|escape:"htmlall"|nl2br}&nbsp;::{if $nuova=="true"}&nbsp;&nbsp;<img src="{$common_basePath}/tpl/unibo/icona_new.gif" width="21" height="9" alt="!NEW!" />{/if}{if $scadenza!=""}{$scadenza|escape:"htmlall"|bbcode2html|nl2br}{/if}</h3>
	...
	<table><tr><td>
	<span class="actions">
		{if $modifica!="" && $elimina!=""}&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/tpl/unibo/news_edt.gif" width="15" height="15" alt="modifica" />
		<a href="/?do={$modifica_link|escape:"htmlall"}">{$modifica|escape:"htmlall"|nl2br}</a>
		&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/tpl/unibo/file_del.gif" width="15" height="15" alt="elimina" />
		<a href="/?do={$elimina_link|escape:"htmlall"}">{$elimina|escape:"htmlall"|bbcode2html|nl2br}</a>
		{/if}
	</span></td><td>
	<div class="piePagina">
		{$data|escape:"htmlall"|nl2br}&nbsp;|&nbsp;<a href="{$autore_link|escape:"htmlall"}">{$autore|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="/?do=ShowPermalink&amp;id_notizia={$id_notizia}">permalink</a>
	</div>
	</td></tr></table>
</div>
