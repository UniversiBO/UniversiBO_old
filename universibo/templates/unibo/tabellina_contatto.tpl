...
<div class="chi_siamo">
	...
	{if $collaboratore.modifica !== ""}
	  <span class="actions">&nbsp;&nbsp;&nbsp;<img src="tpl/unibo/file_edit_32.gif" width="15" height="15" alt="modifica" />
	    <a href="index.php?do={$collaboratore.modifica_link|escape:"htmlall"}">{$collaboratore.modifica|escape:"htmlall"|nl2br}</a>
	  </span>
	{/if}  
