...
{if $common_langCanaleMyUniversiBO != '' }
	<div class="comandi">{if $common_canaleMyUniversiBO == "remove"}
		<img src="{$common_basePath}/tpl/unibo/esame_myuniversibo_del.gif" width="15" height="15" alt="" />&nbsp;
	{else}<img src="{$common_basePath}/tpl/unibo/esame_myuniversibo_add.gif" width="15" height="15" alt="" />&nbsp;
