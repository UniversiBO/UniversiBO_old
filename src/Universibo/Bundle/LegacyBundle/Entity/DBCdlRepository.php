...
EOT;
        ...
        $query = 'SELECT b.id_canale, cod_corso, desc_corso, categoria, cod_fac, cod_doc, cat_id FROM classi_corso b WHERE
        b.cod_fac = '.$db->quote($codiceFacolta).$and.' ORDER BY 4 , 2';
