...
class ShowCredits extends UniversiboCommand
{
    public function execute()
    {
        ...
        $template
                ->assignUnicode('showCredits_langIntro',
        ...
        $template
                ->assignUnicode('showCredits_langSO',
...
[url=http://www.gentoo.org]www.gentoo.org[/url]');
        $template
                ->assignUnicode('showCredits_langApache',
...
[url=http://www.apache.org]www.apache.org[/url]');
        $template
                ->assignUnicode('showCredits_langPostgres',
...
[url=http://www.postgresql.org]www.postgresql.org[/url]');
        $template
                ->assignUnicode('showCredits_langPhp',
...
[url=http://www.php.net]www.php.net[/url]');
        $template
                ->assignUnicode('showCredits_langPhpAccelerator',
...
[url=http://www.php-accelerator.co.uk/]http://www.php-accelerator.co.uk/[/url]');
        $template
                ->assignUnicode('showCredits_langSmarty',
...
[url=http://www.smarty.net]www.smarty.net[/url]');
        ...
        $template
                ->assignUnicode('showCredits_langOthers',
...
[url=http://www.phpbb.com]www.phpbb.com[/url]');
        $template
                ->assignUnicode('showCredits_langW3c',
