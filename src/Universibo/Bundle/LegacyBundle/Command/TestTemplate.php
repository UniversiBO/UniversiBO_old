...
class TestTemplate extends UniversiboCommand
{
    public function execute()
    {
        ...
        /*
                ...
                $common_calendarLink = array ('label'=>'Agosto', 'uri'=>'/?do=ShowCalendar&amp;month=8');
        ...
        $fac_listCdl[] = array('cod' => '0048', 'name' => 'ELETTRONICA',
                'link' => '/?do=showCdl&amp;id_cdl=0048&amp;anno_accademico=2003');
        $fac_listCdl[] = array('cod' => '0049', 'name' => 'GESTIONALE',
                'link' => '/?do=showCdl&amp;id_cdl=0049&amp;anno_accademico=2003');
        $fac_listCdl[] = array('cod' => '0050',
                'name' => 'DEI PROCESSI GESTIONALI',
                'link' => '/?do=showCdl&amp;id_cdl=0050&amp;anno_accademico=2003');
        $fac_listCdl[] = array('cod' => '0051', 'name' => 'INFORMATICA',
                'link' => '/?do=showCdl&amp;id_cdl=0051&amp;anno_accademico=2003');

        $fac_listCdlType = array(); //fac := lista categorie degli anni di cdl
        $fac_listCdlType[] = array('cod' => 'L',
                'name' => 'Lauree Triennali/Primo Livello',
                'list' => $fac_listCdl);
        $fac_listCdlType[] = array('cod' => 'S',
                'name' => 'Lauree Specialistiche', 'list' => $fac_listCdl);
        $fac_listCdlType[] = array('cod' => 'V',
                'name' => 'Lauree Vecchio Ordinamento', 'list' => $fac_listCdl);
        ...
        $template
                ->assign('fac_langList',
                        'Elenco corsi di laurea attivi su UniversiBO');
        ...
        /*
                ...
                $cdl_cicle[] = array('name'='CALCOLATORI ELETTRONICI L-A', 'teacher' => 'NERI GIOVANNI', 'link' => '/?do=ShowCourse&amp;id_argomento=56');
                $cdl_cicle[] = array('name'='COMUNICAZIONI ELETTRICHE L-A', 'teacher' => 'CAINI CARLO', 'link' => '/?do=ShowCourse&amp;id_argomento=59');
                $cdl_cicle[] = array('name'='SISTEMI OPERATIVI L-A', 'teacher' => 'CIAMPOLINI ANNA', 'link' => '/?do=ShowCourse&amp;id_argomento=56');
