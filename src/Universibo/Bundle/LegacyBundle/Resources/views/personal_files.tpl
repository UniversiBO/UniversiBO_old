...
<div class="elenco">
	...
	<a href="{$item.editUri|escape:"htmlall"}"><img src="{$common_basePath}/tpl/unibo/file_edit_32.gif" border="0" width="15" height="15" alt="modifica" title="modifica" hspace="1"/></a>
	<a href="{$item.downloadUri|escape:"htmlall"}"><img src="{$common_basePath}/tpl/unibo/file_download.gif" border="0" width="15" height="15" alt="download" title="download" hspace="1"/></a>
	</p>
</div> 
{/foreach}
