	...
	<div class="elencoFile">
		...
		{foreach name=showmyfiletitoli from=$showAllFilesStudentiTitoli_fileList item=temp_file}
			<tr class="{if ($smarty.foreach.showmyfiletitoli.iteration % 2) == 0}odd{else}even{/if}">
				...
				<td><a href="{$temp_file.download_uri|escape:"htmlall"}"><img src="{$common_basePath}/bundles/universibodesign/images/file_download.gif" border="0" width="15" height="15" alt="scarica il file" vspace="2" hspace="1"/></a>&nbsp;</td>
