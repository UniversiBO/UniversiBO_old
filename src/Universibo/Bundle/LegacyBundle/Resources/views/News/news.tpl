...
<div class="news">
	...
	<table><tr><td>
	<span class="actions">
		{if $modifica!="" && $elimina!=""}&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/bundles/universibodesign/images/news_edt.gif" width="15" height="15" alt="modifica" />
		<a href="{$modifica_link|escape:"htmlall"}">{$modifica|escape:"htmlall"|nl2br}</a>
		&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/bundles/universibodesign/images/file_del.gif" width="15" height="15" alt="elimina" />
