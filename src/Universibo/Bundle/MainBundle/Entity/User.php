...
/**
 * @ORM\Entity(repositoryClass="Universibo\Bundle\MainBundle\Entity\UserRepository")
...
class User extends BaseUser implements EncoderAwareInterface
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Universibo\Bundle\MainBundle\Entity\Group")
     ...
     * FOSUserBundle groups
     *
     * @ORM\ManyToMany(targetEntity="Universibo\Bundle\MainBundle\Entity\UniboGroup")
