...
use Universibo\Bundle\MainBundle\Form\UserType;
    ...
    public function updateAction()
    {
        ...
        if ($form->isValid()) {
            if (count($user->getContacts()) > 3) {
                ...
                $verificationService = $this->get('universibo_main.contact.verification');
        ...
        return $this->redirect($this->generateUrl('universibo_main_profile_edit', array(), true));
    }
