...
class LinkEdit extends CanaleCommand
{
    ...
    function execute()
    {
        ...
        {
            Error :: throwError(_ERROR_DEFAULT, array ('id_utente' => $user->getIdUser(), 'msg' => 'L\'id del link richiesta non �	valido', 'file' => __FILE__, 'line' => __LINE__));
        }
        if ($canale->getServizioLinks() == false)
            Error :: throwError(_ERROR_DEFAULT, array ('id_utente' => $user->getIdUser(), 'msg' => "Il servizio link � disattivato", 'file' => __FILE__, 'line' => __LINE__));
