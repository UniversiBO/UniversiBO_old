...
class ShowContribute extends UniversiboCommand
{
    public function execute()
    {
        ...
        $template->assignUnicode('contribute_langIntro',array('UniversiBO è un sito che nasce dalla collaborazione tra studenti, docenti e strutture universitarie. I docenti sono stati disponibili a dare il loro contributo e li ringraziamo per questo. Ma per permettere che questo portale continui la sua vita occorre che anche gli studenti collaborino.',
      ...
      'Se quindi vi abbiamo convinto con queste poche e semplici parole e volete
        ...
        $template->assignUnicode('question_q1Answers', array('una giornata alla settimana o più;','poche ore alla settimana;','pochi minuti alla settimana;'));
        ...
        $template->assignUnicode('question_q3', 'Quali di queste attività pensi di poter svolgere (anche più di una scelta)?');
        $template->assignUnicode('question_q3AnswersMulti', array('attività off-line(contatti con i docenti o studenti, reperimento materiale...);','moderatore
