...
class NewPasswordStudente extends UniversiboCommand
{
    ...
    function execute()
    {
        ...
        if ( $f5_accept == true )
        {
            ...
            $template->assignUnicode('newPasswordStudente_thanks',"Una nuova password è stata generata, la tua richiesta è stata inoltrata e a breve riceverai le informazioni al tuo indirizzo e-mail di ateneo\n".
