...
public class GJVoidDepthFirst<A> implements GJVoidVisitor<A> {
    ...
    *       | opDefinition()
    */
   public void visit(istruzione n, A argu) {
      n.f0.accept(this, argu);
   }
    ...
    * f4 -> <END>
    */
   public void visit(eventDefinition n, A argu) {
      n.f0.accept(this, argu);
    ...
    * f4 -> <END>
    */
   public void visit(startDefinition n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
    ...
    * f19 -> <END>
    */
   public void visit(opDefinition n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
    ...
    */
   public void visit(listaParam n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
    ...
    * f3 -> <STOP>
    */
   public void visit(outputFilter n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
    ...
    * f3 -> "}"
    */
   public void visit(lista n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
    ...
    *       | <STRINGA>
    */
   public void visit(elem n, A argu) {
      n.f0.accept(this, argu);
   }
    ...
    * f3 -> <NSRIGHT>
    */
   public void visit(namespace n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      n.f3.accept(this, argu);
