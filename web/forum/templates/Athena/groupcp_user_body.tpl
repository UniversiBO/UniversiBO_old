...
{TPL_HDR1}<span class="cattitle">{L_GROUP_MEMBERSHIP_DETAILS}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
...
{TPL_HDR1}<span class="cattitle">{L_JOIN_A_GROUP}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
<tr> 
