...
{TPL_HDR1}<span class="cattitle">{L_SEARCH_MATCHES}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
  ...
  <!-- BEGIN searchresults -->
  <tr> 
	<td class="row3" align="center" valign="middle"><img src="{searchresults.TOPIC_FOLDER_IMG}" width="19" height="18" alt="{searchresults.L_TOPIC_FOLDER_ALT}" title="{searchresults.L_TOPIC_FOLDER_ALT}" /></td>
	<td class="row1" {C_ONMOUSEOVER}="this.style.backgroundColor='{C_ROW1_OVER}';" {C_ONMOUSEOUT}="this.style.backgroundColor='{C_ROW1}';" {C_ONCLICK}="window.location.href='{searchresults.U_VIEW_FORUM}'"><span class="forumlink"><a href="{searchresults.U_VIEW_FORUM}" class="forumlink">{searchresults.FORUM_NAME}</a></span></td>
	<td class="row2" {C_ONMOUSEOVER}="this.style.backgroundColor='{C_ROW2_OVER}';" {C_ONMOUSEOUT}="this.style.backgroundColor='{C_ROW2}';" {C_ONCLICK}="window.location.href='{searchresults.U_VIEW_TOPIC}'"><span class="topictitle">{searchresults.NEWEST_POST_IMG}{searchresults.TOPIC_TYPE}<a href="{searchresults.U_VIEW_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span><br /><span class="gensmall">{searchresults.GOTO_PAGE}</span></td>
