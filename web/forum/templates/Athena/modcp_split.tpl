...
{TPL_HDR1}<span class="cattitle">{L_SPLIT_TOPIC}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
<tr> 
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="{T_TEMPLATE_PATH}/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
