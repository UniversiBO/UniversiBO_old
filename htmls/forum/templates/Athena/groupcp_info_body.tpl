...
{TPL_HDR1}<span class="cattitle">{L_GROUP_INFORMATION}</span>{TPL_HDR2}<table class="forumline" width="100%" cellspacing="1" cellpadding="4" border="0">
<tr> 
...
{TPL_HDR1}<span class="cattitle">{L_GROUP_MODERATOR}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
<tr> 
...
<tr> 
	<td class="row3" align="center"> {MOD_PM_IMG} </td>
	<td class="row1" align="center" {C_ONMOUSEOVER}="this.style.backgroundColor='{C_ROW1_OVER}';" {C_ONMOUSEOUT}="this.style.backgroundColor='{C_ROW1}';" {C_ONCLICK}="window.location.href='{U_MOD_VIEWPROFILE}'"><span class="gen"><a href="{U_MOD_VIEWPROFILE}" class="gen">{MOD_USERNAME}</a></span></td>
...
{TPL_HDR1}<span class="cattitle">{L_GROUP_MEMBERS}</span>{TPL_HDR2}<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
<tr> 
	<th class="thCornerL" height="25">{L_PM}</th>
	<th class="thTop">{L_USERNAME}</th>
	<th class="thTop">{L_POSTS}</th>
...
<!-- BEGIN member_row -->
<tr> 
	<td class="row3" align="center"> {member_row.PM_IMG} </td>
	<td class="row1" align="center" {C_ONMOUSEOVER}="this.style.backgroundColor='{C_ROW1_OVER}';" {C_ONMOUSEOUT}="this.style.backgroundColor='{C_ROW1}';" {C_ONCLICK}="window.location.href='{member_row.U_VIEWPROFILE}'"><span class="gen"><a href="{member_row.U_VIEWPROFILE}" class="gen">{member_row.USERNAME}</a></span></td>
