...
{TPL_HDR1}<span class="cattitle">{L_TOPIC_REVIEW}</span>{TPL_HDR2}<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		<td colspan="2" height="1" class="spaceRow"><img src="{T_TEMPLATE_PATH}/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	 <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
