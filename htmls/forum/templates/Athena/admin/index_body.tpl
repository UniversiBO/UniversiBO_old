...
<h1>Athena phpBB Style Notes</h1>
<p>
...
<br />
To change style configuration edit file "templates/Athena/Athena.cfg". That file allowes you to enable/disable clickable cells and change color of cells.<br />
<br />
