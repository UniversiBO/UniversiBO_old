...
{POLLBOX} 
<tr> 
	<td class="catBottom" colspan="2" align="center" height="26"> {S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" /></td>
</tr>
</table>{TPL_FTR}
