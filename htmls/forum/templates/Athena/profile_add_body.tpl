...
{TPL_HDR1}<span class="cattitle">{L_REGISTRATION_INFO}</span>{TPL_HDR2}<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
	...
	<tr>
		<td class="catBottom" colspan="2" align="center" height="26">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
	</tr>
</table>{TPL_FTR}
