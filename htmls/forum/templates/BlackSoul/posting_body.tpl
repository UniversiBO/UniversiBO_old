...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
				...
				<tr> 
				  <td><span class="genmed"> &nbsp;{L_FONT_COLOR}: 
					<select name="addbbcode18" onChange="bbfontstyle('[color=' + this.form.addbbcode18.options[this.form.addbbcode18.selectedIndex].value + ']', '[/color]')" onMouseOver="helpline('s')">
					  ...
					  <option style="color:black; background-color: #FFFFFF " value="7" class="genmed">{L_FONT_TINY}</option>
					  <option style="color:black; background-color: #FFFFFF " value="9" class="genmed">{L_FONT_SMALL}</option>
					  <option style="color:black; background-color: #FFFFFF " value="12" selected class="genmed">{L_FONT_NORMAL}</option>
					  <option style="color:black; background-color: #FFFFFF " value="18" class="genmed">{L_FONT_LARGE}</option>
					  <option style="color:black; background-color: #FFFFFF " value="24" class="genmed">{L_FONT_HUGE}</option>
					</select>
					</span></td>
	...
	{POLLBOX} 
	<tr> 
	  <td class="catBottom" colspan="2" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="6" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="5" name="post" class="mainoption" value="{L_SUBMIT}" /></td>
	</tr>
  </table>
